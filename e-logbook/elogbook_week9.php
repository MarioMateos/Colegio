    ...
    <div class = "panel">
      ...
      <div class="panel-body pbody">
        <div id="navigation_holder">
          <ul class = "pager">
             <li class = "previous"><a href = "elogbook_week8.php">&larr; Anterior</a></li>
             <li class = "next"><a href = "elogbook_week10.php">Siguiente &rarr;</a></li>
        </ul>
        </div>
        <div id="week_holder">
          <span style="font-size:1.3em;font-weight:bold;">Semana 9</span>
        </div>
        <hr>
        ...
        <tbody>
          <?php
                  ...
                  $get_previous_data = "SELECT * FROM week9_table WHERE index_number='$student_index_number'";
