    ...
    <div class = "panel">
      ...
      <div class="panel-body pbody">
        <div id="navigation_holder">
          <ul class = "pager">
             <li class = "previous"><a href = "elogbook_week3.php">&larr; Anterior</a></li>
             <li class = "next"><a href = "elogbook_week5.php">Siguiente &rarr;</a></li>
        </ul>
        </div>
        <div id="week_holder">
          <span style="font-size:1.3em;font-weight:bold;">Semana 4</span>
        </div>
        <hr>
        ...
        <tbody>
          <?php
                  ...
                  $get_previous_data = "SELECT * FROM week4_table WHERE index_number='$student_index_number'";
				...
				echo "<tr>";
				echo "<td style='padding:20px;text-align:center'>"."Marter"."</td>";
