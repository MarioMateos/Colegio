...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="elogbook.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">Cuaderno</li></a>
  <a class="menu_items_link" href="../company_supervisor/company_supervisor_login.php"><li class="menu_items_list">Supervisor de la compañía
</li></a>
  <a class="menu_items_link" href="../visiting_supervisor/visiting_supervisor_login.php"><li class="menu_items_list">Supervisor visitante
</li></a>
  ...
  <div class="container-fluid">
    <div class = "panel">
      <div class = "panel-heading phead">
         <h2 class = "panel-title ptitle"> Cuaderno</h2>
      </div>
      <div class="panel-body pbody">
        <div id="navigation_holder">
          <ul class = "pager">
             <li class = "previous"><a href = "elogbook_week6.php">&larr; Anterior</a></li>
             <li class = "next"><a href = "elogbook_week8.php">Siguiente &rarr;</a></li>
        </ul>
        </div>
        <div id="week_holder">
          <span style="font-size:1.3em;font-weight:bold;">Semana 7</span>
        </div>
        <hr>
        ...
        <thead>
            <tr>
                ...
                <th style='text-align:center'>Trabajo asignado al estudiante</th>
                <th style='text-align:center'>Habilidad Especial Adquirida</th>
        ...
        <tbody>
          <?php
                  ...
                  $get_previous_data = "SELECT * FROM week7_table WHERE index_number='$student_index_number'";
				...
				echo "<tr>";
				echo "<td style='padding:20px;text-align:center'>"."Lunes"."</td>";
				...
				echo "<tr>";
				echo "<td style='padding:20px;text-align:center'>"."Martes"."</td>";
				...
				echo "<tr>";
				echo "<td style='padding:20px;text-align:center'>"."Miercoles"."</td>";
				...
				echo "<tr>";
				echo "<td style='padding:20px;text-align:center'>"."Jueves"."</td>";
				...
				echo "<tr>";
				echo "<td style='padding:20px;text-align:center'>"."Viernes"."</td>";
