...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="../student_assumption/student_assumption.php"><li class="menu_items_list">Presentar Asunción</li></a>
    ...
    <div class = "panel">
      ...
      <div class="panel-body pbody">
        <div id="navigation_holder">
          <ul class = "pager">
             <li class = "previous"><a href = "elogbook_week2.php">&larr; Anterior</a></li>
             <li class = "next"><a href = "elogbook_week4.php">Siguiente &rarr;</a></li>
        </ul>
        </div>
        <div id="week_holder">
          <span style="font-size:1.3em;font-weight:bold;">Semana 3</span>
        </div>
        <hr>
