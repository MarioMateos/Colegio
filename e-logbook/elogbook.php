      ...
      <div class="panel-body pbody">
        <div id="navigation_holder">
          <ul class = "pager">
             ...
             <li class = "next"><a href = "elogbook_week2.php">Siguiente &rarr;</a></li>
        </ul>
        </div>
        <div id="week_holder">
          <span style="font-size:1.3em;font-weight:bold;">Semana 1</span>
        </div>
        <hr>
        ...
        <thead>
            <tr>
                ...
                <th style='text-align:center'>  Habilidad Especial Adquirida
</th>
        ...
        <tbody>
          <?php
				...
				echo "<tr>";
				echo "<td style='padding:20px;text-align:center'>"."miércoles"."</td>";
