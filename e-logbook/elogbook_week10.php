    ...
    <div class = "panel">
      ...
      <div class="panel-body pbody">
        <div id="navigation_holder">
          <ul class = "pager">
             <li class = "previous"><a href = "elogbook_week9.php">&larr; Anterior</a></li>
             <li class = "next disabled"><a href = "#">Siguiente &rarr;</a></li>
        </ul>
        </div>
        <div id="week_holder">
          <span style="font-size:1.3em;font-weight:bold;">Semana 10</span>
        </div>
        <hr>
        ...
        <tbody>
          <?php
                  ...
                  $get_previous_data = "SELECT * FROM week10_table WHERE index_number='$student_index_number'";
