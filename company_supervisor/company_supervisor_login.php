...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="../e-logbook/elogbook.php"><li class="menu_items_list">Cuadernok</li></a>
    ...
    <div class = "panel">
      <form method="post" action="">
       <div class = "panel-heading phead">
          <h2 class = "panel-title ptitle">Login - Supervisor de la compañía
</h2>
       </div>
