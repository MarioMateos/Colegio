...
<div id="student_name"><span style="color:rgb(255, 198, 0);font-size:1.1em"><em>Bienvenidos,</em>&nbsp; </span><span style="font-family:serif"><?php echo $student_fname." ".$student_lname;?></span></div>
</div>

<div id="left_side_bar">
<ul id="menu_list">
  <a class="menu_items_link" href="../instructions_page/instructions_page.php"><li class="menu_items_list">Instrucciones</li></a>
  <a class="menu_items_link" href="../Register_page/Register_page.php"><li class="menu_items_list">Registro</li></a>
  ...
  <a class="menu_items_link" href="company_supervisor_login.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px"> Supervisor de la compañía</li></a>
  ...
  <div class="container-fluid">
    <div class = "panel">
       <div class = "panel-heading phead">
          <h2 class = "panel-title ptitle">Grados de supervisor de la compañía</h2>
       </div>
        <div class = "panel-body pbody">
          <form method="post" action="">
          <table class="table table-bordered">

            <caption><strong><u> DIRECCIONES </u> &nbsp; : </strong>&nbsp;Indique haciendo clic en las opciones a continuación para indicar el grado en que el alumno se ajusta mejor a las competencias que se indican a continuación.</caption>
             <tr >
                  <td rowspan="2" style="padding-top:30px;padding-bottom:20px;text-align:center;width:60%"> COMPETENCIAS </td>
                  <td style="width:40%" colspan="6"> 0&nbsp;-&nbsp;AUSENTE &nbsp;&nbsp;&nbsp;&nbsp;  1&nbsp;-&nbsp;DÉBILES &nbsp;&nbsp; 2&nbsp;-&nbsp;DEBAJO DEL PROMEDIO</td>
             </tr>
             <tr>
                  <td colspan="6"> 3&nbsp;-&nbsp;PROMEDIO
  &nbsp;&nbsp; 4&nbsp;-&nbsp;BUENO &nbsp;&nbsp; 5&nbsp;-&nbsp;EXCEPCIONAL</td>
             </tr>

             <tr style="text-align:center;font-weight:bold">
                 <td>Puntos de Grado</td>
                   <td>0</td>
                   <td>1</td>
                   <td>2</td>
                   <td>3</td>
              ...
              <tr style="font-weight:bold">
                  <td colspan="7" style="font-weight:bold">A. &nbsp; HABILIDADES ESPECÍFICAS (Habilidades relacionadas con el trabajo asignado al estudiante)
</td>
              </tr>
          ...
          <tr style="font-weight:bold">
              <td colspan="7" style="font-weight:bold">B. &nbsp; HABILIDADES GENERALES EMPLEABLES</td>
          </tr>

          <tr>
            <td><span style="font-size:1.1em">Posibilidad de completar el trabajo a tiempo</span></td>
          ...
          <tr>
            <td><span style="font-size:1.1em">Posibilidad de seguir las instrucciones cuidadosamente</span></td>
          ...
          <tr>
            <td><span style="font-size:1.1em">Capacidad de hacer iniciativas</span></td>
          ...
          <tr>
            <td><span style="font-size:1.1em">Capacidad de trabajar con poca supervisión</span></td>
          ...
          <tr>
            <td><span style="font-size:1.1em">Cumplimiento de las reglas y regulaciones de la organización</span></td>
          ...
          <tr>
            <td><span style="font-size:1.1em">Cumplimiento de las normas de seguridad y medioambientales</span></td>
          ...
          <tr>
            <td><span style="font-size:1.1em">Inventiva</span></td>
          ...
          <tr style="font-weight:bold">
              <td colspan="7" style="font-weight:bold">C. &nbsp; ACTITUD PARA TRABAJAR</td>
          </tr>

          <tr>
            <td><span style="font-size:1.1em">Asistencia al trabajo</span></td>
          ...
          <tr>
            <td><span style="font-size:1.1em">Puntualidad</span></td>
          ...
          <tr>
            <td><span style="font-size:1.1em">Deseo de trabajar</span></td>
          ...
          <tr>
            <td><span style="font-size:1.1em">Voluntad de aceptar nuevas ideas</span></td>
          ...
          <tr style="font-weight:bold">
              <td colspan="7" style="font-weight:bold">D. &nbsp; RELACIONES HUMANAS</td>
          </tr>

          <tr>
            <td><span style="font-size:1.1em">Relación con colegas</span></td>
          ...
          <tr>
            <td><span style="font-size:1.1em">Relación con superiores</span></td>
          ...
          <tr>
            <td><span style="font-size:1.1em">Capacidad de controlar las emociones cuando se las provoca</span></td>
