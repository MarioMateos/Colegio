...
<div id="student_name"><span style="color:rgb(255, 198, 0);font-size:1.1em"><em>Bienvenido visite http://tusolutionweb.blogspot.pe/,</em>&nbsp; </span><span style="font-family:serif"><?php echo $student_fname." ".$student_lname;?></span></div>
</div>
...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="student_assumption.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">Presentar Asunción</li></a>
...
<div id="main_content">
  <div class="container-fluid">
    <div class = "panel">
       <div class = "panel-heading phead">
          <h2 class = "panel-title ptitle"> FORMULARIO DE ASUNCIÓN DE DERECHO</h2>
       </div>
          ...
          <div class="panel panel-adjusted">
           <div class="panel-body pbody_student_info">
             <br>
             <div style="float:left;font-size:.9em"><strong>Información del estudiante</strong></div>
             <hr>
         <form method="post" action="">
          ...
          <div class="form-group">
           <label for="txtlname">Apellidos </label>
        ...
        <div class="form-group">
         <label for="txtprogramme">programa </label>
       ...
       <div class="form-group">
        <label for="txtsession">Sesión </label>
     ...
     <br>
     <div style="float:left;font-size:.9em"><strong>Información de la compañía</strong></div>
     <hr>
    ...
    <div class="form-group">
     <label for="txtsupervisorsname">Nombre del supervisor : </label>
   ...
   <div class="form-group">
    <label for="txtsupervisorscontact">Supervisores Contacto : </label>
  ...
  <div class="form-group">
   <label for="txtsupervisorsemail">Correo electrónico de los supervisores : </label>
   <input type="email" class="form-control form-control-adjusted" id="txtsupervisorsemail" placeholder="Enter supervisors e-mail" name="txt_supervisors_email">
     ...
     <div class="form-group">
     <label for="selected_region">Seleccione la región de la compañía :</label>
