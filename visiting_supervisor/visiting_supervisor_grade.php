...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="visiting_supervisor_login.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">Supervisor visitante</li></a>
  <a class="menu_items_link" href="../submit_report/submit_report.php"><li class="menu_items_list">Enviar reporte</li></a>
  <a class="menu_items_link" href="../login/index.php"><li class="menu_items_list">Cerrar sesión
</li></a>
</ul>
</div>
       ...
       <div class = "panel-heading phead">
        ...
        <div class = "panel-body pbody">
          ...
          <table class="table table-bordered">
            ...
            <caption><strong><u> DIRECCIONES
 </u> &nbsp; : </strong>&nbsp;Indique haciendo clic en las opciones a continuación para indicar el grado en que el alumno se ajusta mejor a las competencias que se indican a continuación.</caption>
             <tr >
                  <td rowspan="2" style="padding-top:30px;padding-bottom:20px;text-align:center;width:60%"> COMPETENCIAS </td>
                  <td style="width:40%" colspan="6"> 0&nbsp;-&nbsp;AUSENTE &nbsp;&nbsp;&nbsp;&nbsp;  1&nbsp;-&nbsp;DÉBILES
 &nbsp;&nbsp; 2&nbsp;-&nbsp;DEBAJO DEL PROMEDIO</td>
             </tr>
             <tr>
                  <td colspan="6"> 3&nbsp;-&nbsp;PROMEDIO  &nbsp;&nbsp; 4&nbsp;-&nbsp;BUENO &nbsp;&nbsp; 5&nbsp;-&nbsp;EXCEPCIONAL</td>
             </tr>
             ...
             <tr style="text-align:center;font-weight:bold">
              ...
              <tr style="font-weight:bold">
                  <td colspan="7" style="font-weight:bold">A. &nbsp;HABILIDADES ESPECÍFICAS (Habilidades relacionadas con el trabajo asignado al estudiante)</td>
              </tr>
