...
<ul id="menu_list">
  <a class="menu_items_link" href="view_registered_students.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">Estudiantes Registrados</li></a>
  ...
  <a class="menu_items_link" href="#"><li class="menu_items_list">Visitante supervisor de puntuaciones</li></a>
  <a class="menu_items_link" href="../company_score/company_supervisor_score.php"><li class="menu_items_list">Supervisor de la compañía
 Puntuación</li></a>
  ...
  <div class="container-fluid">
    <div class = "panel">
       <div class = "panel-heading phead">
          <h2 class = "panel-title ptitle"> Ver estudiantes registrados</h2>
       </div>
