			...
			<ul id="menu_list">
			  ...
			  <a class="menu_items_link" href="../students_assumptions/students_assumptions.php"><li class="menu_items_list" >Supuestos del estudiante</li></a>
			  <a class="menu_items_link" href="assign_supervisors.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">Asignar supervisores</li></a>
			  ...
			  <a class="menu_items_link" href="../company_score/company_supervisor_score.php"><li class="menu_items_list">Puntuación del supervisor de la compañía</li></a>
			  <a class="menu_items_link" href="../change_password/change_password.php"><li class="menu_items_list">Cambia la contraseña</li></a>
			...
			<div id="main_content">
				<div class = "panel">
				   <div class = "panel-heading phead">
					  <h2 class = "panel-title ptitle">Asignar supervisores</h2>
				   </div>
						<div class = "panel-body pbody">

						<div class = "panel">
						<div class = "panel-heading phead">
							<h2 class = "panel-title ptitle"> Estadísticas de estudiantes</h2>
					   </div>
							<div class = "panel-body pbody">
						  ...
						  <table class="table table-bordered table-hover">
							  ...
							  <thead>
								<tr>
									<th style="text-align:center">Gran Accra</th>
									<th style="text-align:center">Central</th>
									<th style="text-align:center">Oriental</th>
									<th style="text-align:center">occidental</th>
									<th style="text-align:center">Ashanti</th>
									<th style="text-align:center">Del Norte</th>
						   ...
						   <div class = "panel">
						<div class = "panel-heading phead">
							<h2 class = "panel-title ptitle">Conferenciantes Registrados</h2>
					   </div>
							<div class = "panel-body pbody">
						  ...
						  <table class="table table-bordered table-hover">
							  ...
							  <thead>
								<tr>
									...
									<th style="text-align:center">Región de residencia</th>
			   ...
			   <div class="panel">
				 <div class = "panel-heading phead phead-adjusted">
					  <h2 class = "panel-title ptitle"> Añadir conferenciante</h2>
				   </div>
			 ...
			 <div class = "panel">
						<div class = "panel-heading phead">
						  ...
						  <table class="table table-bordered table-hover">
							  ...
							  <thead>
								<tr>
									<th style="text-align:center" width="10%">Regiones</th>
									<th colspan="5" style="text-align:center">Facultades </th>
