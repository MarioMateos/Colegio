...
<head>
  ...
  <link rel="stylesheet" href="visiting_supervisors_score.css"/>
...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="visiting_supervisors_score.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">Supervisores visitantes puntuacion</li></a>
  ...
  <div class="container-fluid">
    <div class = "panel">
       <div class = "panel-heading phead">
          <h2 class = "panel-title ptitle"> Supervisores visitantes puntuacion</h2>
       </div>
              ...
              <table class="table table-bordered table-hover">
                  ...
                  <thead>
                    <tr>
                        ...
                        <th style="text-align: center">Nombre del supervisor visitante</th>
                        <th style="text-align: center">Contacto supervisor visitante</th>
