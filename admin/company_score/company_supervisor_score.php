...
if(isset($_POST["btn_search"])){
  ...
  if($search_by!=""&& $search_term!=""){
    ...
    switch ($search_by) {
      ...
      $mysql_query_1 = "SELECT * FROM vira_registration WHERE company_supervisor_grade LIKE '%$search_term%'";
...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="company_supervisor_score.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">Puntuación del supervisor de la compañía
</li></a>
  ...
  <div class="container-fluid">
    <div class = "panel">
       <div class = "panel-heading phead">
          <h2 class = "panel-title ptitle"> Puntuación de los supervisores de la compañía
 </h2>
       </div>
              ...
              <table class="table table-bordered table-hover">
                  ...
                  <thead>
                    <tr>
                        ...
                        <th style="text-align: center">Nombre del supervisor de la compañía</th>
                        <th style="text-align: center">Supervisor de la compañía</th>
