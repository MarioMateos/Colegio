...
<body>
  ...
  <div class="login-wrap">
	<div class="login-html">
		...
		<div id="text_holder">
			<h2> <span style="color:rgba(213, 159, 15);text-align:center;font-family:sans">Proyectos I+D II <br><br>Sistema Final para aprobar la materia.</span></h2>
		</div>
		<input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Iniciar sesión</label>
		<input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">Regístrate
</label>
		<div class="login-form">
      <form method="post" action="">
			<div class="sign-in-htm">
				<div class="group">
					<label for="user" class="label">Matricula del usuario</label>
				...
				<div class="group" style="text-align: center">
					<a href="admin/index.php"><u style="color:#D59F0F">Administrador</u></a>
				</div>
      ...
      <form method="post" action="">
        ...
        <div class="group">
          <label for="index_number" class="label">Matricula</label>
